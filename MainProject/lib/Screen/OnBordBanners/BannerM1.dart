...
// Main Widget for the Banner
class BannerM1 extends StatefulWidget {
  const BannerM1({super.key});

  @override
  _BannerM1State createState() => _BannerM1State();
}

class _BannerM1State extends State<BannerM1> {
  // Store the favorite state for each product
